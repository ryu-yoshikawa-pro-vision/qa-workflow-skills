...
- **Input**: レビュー対象QA成果物と、その正否を判定できるCurrent Effective Authorityまたは上流根拠。Product Risk、Coverage Criteria、Canonical Registry、案件コンテキスト、前後成果物は利用可能な場合に補助入力とします。
- **Function**: 生成時の意図を引き継がず、上流根拠からCold Reviewし、誤り・抜け・過剰・根拠不足・追跡性欠陥を重大度付きで検出して責任Skillへ戻します。
