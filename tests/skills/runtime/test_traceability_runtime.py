...
def runtime_row(skill: str, unit: str, model_key: str | None = None, *, materialize: bool = False, materialize_model_key: str | None = None) -> dict:
    return {
        ...
        "model_completion": [{
            ...
            "active_ci_ids": ["TCN-001-CI01"] if materialize else [],
            "semantic_item_keys": [],
...
def base_request() -> dict:
    ...
    units = [runtime_row("test-condition-design", "artifact:condition_structure:all"), runtime_row("test-condition-design", "model:ep-001", "ep-001"), runtime_row("test-condition-design", "artifact:materialize_coverage:TCN-001", materialize=True, materialize_model_key="ep-001")]
    return {
        "metadata": metadata(),
        "input": {
